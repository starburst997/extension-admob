...
class AdMob {
	...
	public static function initIOS(bannerId:String, interstitialId:String, gravityMode:GravityMode){
		...
		try{
			...
			__showRewarded = function(){ trace("showRewardedAd is not yet implemented on iOS. If you want to contribute with a Pull Request on GitHub, please try to do it :)"); }
